...
use crate::specs::common::service::v1_7::Service;
use crate::specs::common::signature::Signature;
use crate::specs::v1_7::component::Component;
    ...
    use crate::{
        ...
        specs::{
            common::{
                ...
                service::v1_7::test::example_service,
                signature::test::example_signature,
            },
            v1_7::component::test::example_component,
        },
